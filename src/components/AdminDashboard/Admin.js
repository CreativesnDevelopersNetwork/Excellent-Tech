     ...
     <div className="mediaNavbar">
      <div className="mediaNavbar-links">
        <div className="mediaNavbarLogo">
          <h1 className="text-white">Excellent<i className='goldText'>Tech</i></h1>
        </div>
      ...
      <div className="app-header-right">
          <button className="add-btn" title="Add New Project">
            <svg className="btn-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" >
                ...
                >
                  <Popover id="popover-contained">
                    ...
                    <Popover.Body>
                      ...
                      <Link to="/admin" className="btn btn-primary w-100 mt-2 mb-1">
                        Update Profile
                      </Link>
